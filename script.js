document.addEventListener("DOMContentLoaded", function () {
  ...
  sidebarToggle.addEventListener("click", () => {
    ...
    if (isCalendarRendered && calendarInstance) {
      setTimeout(() => {
        // Delay to allow sidebar transition to complete
  ...
  const applyDarkMode = (isDark) => {
    ...
    if (
      typeof patientAdmissionsChartInstance !== "undefined" &&
      patientAdmissionsChartInstance
    ) {
      patientAdmissionsChartInstance.destroy();
      initPatientAdmissionsChart();
    }
    if (
      typeof departmentPopularityChartInstance !== "undefined" &&
      departmentPopularityChartInstance
    ) {
    ...
    if (
      isCalendarRendered &&
      calendarInstance &&
      document.getElementById("appointments").classList.contains("hidden") ===
        false
    ) {
        ...
        datasets: [
          {
            ...
            borderColor: document.documentElement.classList.contains("dark")
              ? "#1f2937"
              : "#ffffff", // Match bg for better look
          },
        ],
      },
      options: {
        ...
        dateClick: function (info) {
          Swal.fire({
            ...
            customClass: {
              ...
              confirmButton:
                "px-4 py-2 rounded-lg font-medium transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800 bg-blue-600 hover:bg-blue-700 text-white focus:ring-blue-500",
              cancelButton:
                "px-4 py-2 rounded-lg font-medium transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800 bg-gray-200 hover:bg-gray-300 text-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200 focus:ring-gray-400 ml-2",
            },
          ...
          Swal.fire({
            ...
            customClass: {
              ...
              confirmButton:
                "px-4 py-2 rounded-lg font-medium transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800 bg-blue-600 hover:bg-blue-700 text-white focus:ring-blue-500",
              denyButton:
                "px-4 py-2 rounded-lg font-medium transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800 bg-red-500 hover:bg-red-600 text-white focus:ring-red-400 ml-2",
              cancelButton:
                "px-4 py-2 rounded-lg font-medium transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800 bg-gray-200 hover:bg-gray-300 text-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200 focus:ring-gray-400 ml-2",
            },
            buttonsStyling: false,
