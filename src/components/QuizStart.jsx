      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            Answer multiple choices questions and see how well you know the
            fundamentals !
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-linear-to-br from-blue-50 to-blue-100 p-6 rounded-xl">
            ...
            <div className="text-2xl font-bold text-blue-800 mb-2">20</div>
            <div className="text-2xl font-medium">Questions</div>
          </div>

          <div className="bg-linear-to-br from-purple-50-50 to-purple-100 p-6 rounded-xl">
            <div className="flex items-center justify-center mb-4">
          ...
          <div className="bg-linear-to-br from-green-50-50 to-green-100 p-6 rounded-xl">
            <div className="flex items-center justify-center mb-4">
          ...
          <div className="text-left bg-gray-50 p-6 rounded-xl max-w-2xl mx-auto">
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start">
                <span className="shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center text-sm font-semibold mr-3 mt-0.5 justify-center">
                  1
                </span>
        ...
        <button
          className="inline-flex items-center space-x-3 py-4 px-8 bg-linear-to-r from-blue-500 to-purple-600 text-white rounded-xl hover:from-blue-600 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-lg font-semibold text-lg cursor-pointer"
